...
UNREALROOTPATH = /home/mango/UnrealEngine
...
TARGETS = \
	...
	VRST-Linux-Shipping  \
	VRST \
	VRSTClient-Linux-Debug  \
	VRSTClient-Linux-DebugGame  \
	VRSTClient-Linux-Test  \
	VRSTClient-Linux-Shipping  \
	VRSTClient \
	VRSTEditor-Linux-Debug  \
	VRSTEditor-Linux-DebugGame  \
	VRSTEditor-Linux-Test  \
	VRSTEditor-Linux-Shipping  \
	VRSTEditor \
	VRSTServer-Linux-Debug  \
	VRSTServer-Linux-DebugGame  \
	VRSTServer-Linux-Test  \
	VRSTServer-Linux-Shipping  \
	VRSTServer \
...
VRST-Linux-Debug:
	 $(PROJECTBUILD) VRST Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRST-Linux-DebugGame:
	 $(PROJECTBUILD) VRST Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRST-Linux-Test:
	 $(PROJECTBUILD) VRST Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
VRSTClient-Linux-Debug:
	 $(BUILD) VRSTClient Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSTClient-Linux-DebugGame:
	 $(BUILD) VRSTClient Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSTClient-Linux-Test:
	 $(BUILD) VRSTClient Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSTClient-Linux-Shipping:
	 $(BUILD) VRSTClient Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSTClient:
	 $(BUILD) VRSTClient Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSTEditor-Linux-Debug:
	 $(PROJECTBUILD) VRSTEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSTEditor-Linux-DebugGame:
	 $(PROJECTBUILD) VRSTEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSTEditor-Linux-Test:
	 $(PROJECTBUILD) VRSTEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
VRSTServer-Linux-Debug:
	 $(BUILD) VRSTServer Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSTServer-Linux-DebugGame:
	 $(BUILD) VRSTServer Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSTServer-Linux-Test:
	 $(BUILD) VRSTServer Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSTServer-Linux-Shipping:
	 $(BUILD) VRSTServer Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

VRSTServer:
	 $(BUILD) VRSTServer Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
DerivedDataTool-Linux-Debug:
	 $(BUILD) DerivedDataTool Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

DerivedDataTool-Linux-DebugGame:
	 $(BUILD) DerivedDataTool Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

DerivedDataTool-Linux-Test:
	 $(BUILD) DerivedDataTool Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

DerivedDataTool-Linux-Shipping:
	 $(BUILD) DerivedDataTool Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

DerivedDataTool:
	 $(BUILD) DerivedDataTool Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
DatasmithSketchUpRuby2023-Linux-Debug:
	 $(BUILD) DatasmithSketchUpRuby2023 Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

DatasmithSketchUpRuby2023-Linux-DebugGame:
	 $(BUILD) DatasmithSketchUpRuby2023 Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

DatasmithSketchUpRuby2023-Linux-Test:
	 $(BUILD) DatasmithSketchUpRuby2023 Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

DatasmithSketchUpRuby2023-Linux-Shipping:
	 $(BUILD) DatasmithSketchUpRuby2023 Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

DatasmithSketchUpRuby2023:
	 $(BUILD) DatasmithSketchUpRuby2023 Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
SwitchboardListenerHelper-Linux-Debug:
	 $(BUILD) SwitchboardListenerHelper Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwitchboardListenerHelper-Linux-DebugGame:
	 $(BUILD) SwitchboardListenerHelper Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwitchboardListenerHelper-Linux-Test:
	 $(BUILD) SwitchboardListenerHelper Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwitchboardListenerHelper-Linux-Shipping:
	 $(BUILD) SwitchboardListenerHelper Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwitchboardListenerHelper:
	 $(BUILD) SwitchboardListenerHelper Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
